...
const ChartTooltipContent = React.forwardRef<
    ...
    React.ComponentProps<'div'> & {
        ...
        formatter?: (value: number | string, name: string, entry: TooltipPayloadItem, index: number, payload: TooltipPayloadItem[]) => React.ReactNode;
    }
>(
    (
        {
            ...
            >
                ...
                <div className="grid gap-1.5">
                    {(payload as TooltipPayloadItem[]).map((item, index) => {
                        ...
                        const itemConfig = getPayloadConfigFromPayload(config, item, key);
                        const indicatorColor = color || item.fill || item.color || item.stroke;
...
// Define type for legend payload
